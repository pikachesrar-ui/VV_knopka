...
from vv_knopka.openai_client import STOCK_FRIENDLY_AI_ANCHORS, recent_visual_anchors
...
def test_recent_visual_anchors_are_read_from_earlier_slots(tmp_path):
    settings = Settings(
    ...
    assert recent_visual_anchors(settings, 3) == ["octopus"]
